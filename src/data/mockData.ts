...
export const AGENTS_CATALOG: AgentDefinition[] = [
  {
    ...
    category: 'Customer',
    description: 'Guides enterprise visitors on Genting digital solutions, performs interactive discovery, and drafts CRM sales inquiries.',
    systemPrompt: 'You are the Genting Website Concierge Agent. Provide clear, grounded advice on Genting cloud solutions, hospitality technology, and gaming platform capabilities using only verified knowledge.',
  ...
  },
  {
    ...
    systemPrompt: 'You are the Enterprise Solutions Architect Agent for Genting. Analyze architectural requirements, evaluate trade-offs between local Ollama and cloud services, and generate compliant ADRs.',
  ...
  },
  {
    ...
    systemPrompt: 'You are the Genting Coding Agent. Write clean, idiomatic code adhering to PEP 8 / TypeScript guidelines. Always produce unit tests alongside implementation. Write draft PRs only.',
  ...
  },
  {
    ...
    systemPrompt: 'You are the Genting QA Agent. Scrutinize code changes for regressions, edge cases, and compliance gaps. Generate test suites with high semantic coverage.',
  ...
  },
  {
    ...
    systemPrompt: 'You are the Genting Release Gate Agent. Verify all SOC2 and deployment gates. Package release artifacts and dispatch human approval signals via Temporal.',
  ...
  },
  {
    ...
    systemPrompt: 'You are the Genting SRE Agent. Diagnose infrastructure anomalies, inspect service health, and present remediation recommendations to on-call engineers.',
...
export const TEMPORAL_WORKFLOWS_SEED: TemporalWorkflow[] = [
  {
    id: 'WF-GENTING-202609-089',
    workflowType: 'EngineeringPRDraftFlow',
    targetEntity: 'TICKET-GENT-4412 (Payment Gateway Idempotency)',
    initiatedBy: 'Developer: K. Mishra',
    startTime: '10 minutes ago',
    status: 'COMPLETED',
    currentStep: 'Draft PR Open in genting-services/payment-core',
    activities: [
      { name: 'FetchJiraTicket', status: 'completed', durationMs: 240, details: 'Fetched GENT-4412 specifications' },
      ...
      { name: 'CreateDraftPR', status: 'completed', durationMs: 380, details: 'PR #128 opened on branch feat/gent-4412-idempotency' }
    ]
  },
  {
    id: 'WF-GENTING-202609-090',
    workflowType: 'WebsiteReleaseWorkflow',
    targetEntity: 'Genting Website v1.4.0 (Mac M2 Local Stack + CMS Staging)',
    ...
    activities: [
      { name: 'VerifyBuildArtifacts', status: 'completed', durationMs: 420, details: 'Container SHA: ghcr.io/genting/web:v1.4.0-m2' },
    ...
    pendingApproval: {
      ...
      action: 'Promote genting-agentic-platform website & agent-gateway to Staging Cluster',
      riskLevel: 'HIGH',
      diffSummary: 'Deploys Local Ollama proxy endpoint, LangGraph v0.2 integration, and updated CMS content schema.',
      approverRole: 'Release Manager / Platform Architect',
      requestedAt: '2026-09-15 01:50:00 UTC'
    }
  },
  {
    id: 'WF-GENTING-202609-091',
...
export const KNOWLEDGE_BASE_SEED: KnowledgeDocument[] = [
  {
    id: 'kb-arch-001',
    title: 'Genting Agentic Engineering Solution Architecture Document (POC)',
    domain: 'architecture',
    source: 'docs/architecture/solution-architecture.md',
    contentSnippet: 'Establishes a proof-of-concept architecture for an agentic software development foundation with the Genting website as the first production use case, centered around Agent Gateway, MCP Gateway, and LLM Gateway.',
    vectorDimensions: 1536,
    tags: ['Architecture', 'Gateways', 'POC', 'Genting'],
  ...
  {
    id: 'kb-cms-001',
    title: 'Genting Resorts World Digital Modernization Offerings',
    domain: 'cms',
    source: 'apps/web/content/solutions/hospitality-ai.md',
    contentSnippet: 'Next-generation smart resort concierge architecture: integrated booking engine, localized language translation via local Ollama models on Apple Silicon edge, and real-time room automation.',
    vectorDimensions: 1536,
    tags: ['Hospitality', 'EdgeAI', 'Ollama', 'ResortsWorld'],
